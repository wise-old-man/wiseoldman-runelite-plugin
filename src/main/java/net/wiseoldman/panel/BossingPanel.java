...
class BossingPanel extends JPanel
{
	...
	private static final List<HiscoreSkill> BOSSES = ImmutableList.of(
		ABYSSAL_SIRE, ALCHEMICAL_HYDRA, ARAXXOR, ARTIO, BARROWS_CHESTS,
		...
		CRAZY_ARCHAEOLOGIST, DERANGED_ARCHAEOLOGIST, DUKE_SUCELLUS,
		GENERAL_GRAARDOR, GIANT_MOLE, GROTESQUE_GUARDIANS, HESPORI,
		HUEYCOATL, KALPHITE_QUEEN, KING_BLACK_DRAGON, KRAKEN, KREEARRA,
		...
		SPINDEL, TEMPOROSS, THE_GAUNTLET, THE_CORRUPTED_GAUNTLET,
